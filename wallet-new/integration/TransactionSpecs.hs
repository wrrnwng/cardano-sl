...
transactionSpecs wRef wc = do
    describe "Transactions" $ do
        ...
        it "Create unsigned transaction and submit it to the blockchain" $ do
            ...
            let RawTransaction txInHexFormat _ = wrData rawTx
                Right txAsBytes = B16.decode txInHexFormat
                txHash = hash txAsBytes
                ...
                addressCreatedFromThisPK = Core.checkPubKeyAddress srcWalletAddressDerivedPK
                                                                   srcWalletAddress
                txSignatureIsValid = checkSig protocolMagic
                                              SignTx
                                              srcWalletAddressDerivedPK
                                              txHash
                                              (Signature txSignature)

            print srcWalletAddressDerivedPK
            print txSignature
            print txHash
